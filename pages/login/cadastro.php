...
<head>
    ...
    <title>REGISTRA-SE ESCOLA DIGITAL</title>
...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="../../config/validacao/valida_cadastro_login.php" method="post">
                ...
                <small class="form-text text-muted">Já tem uma conta? <a href="login.php">Entrar</a></small>
            </form>
        </div>
    </div>
